import 'package:palman_petshop_app/model/pet.dart';
...
final List<Pet> PETS = [
  ...
  Pet(
      ...
      time: '8m',
      price: 75.00,
      imagePath: 'assets/abyssinian.png'),
  Pet(
      id: 4,
      name: 'Burmese Cat',
      weight: '4 kg',
